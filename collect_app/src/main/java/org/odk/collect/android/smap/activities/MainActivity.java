...
package org.odk.collect.android.smap.activities;
...
public class MainActivity extends CollectAbstractActivity implements TaskDownloaderListener,
        NFCListener,
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mDownloadTasks != null) {
                                    mDownloadTasks.setDownloaderListener(null, MainActivity.this);
    ...
    protected class MainTaskListener extends BroadcastReceiver {
        ...
        public MainTaskListener(MainActivity activity) {
            mActivity = activity;
        }
