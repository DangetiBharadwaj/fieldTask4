...
//import org.odk.collect.android.tasks.SmapRemoteWebServicePostTask;   XXXX
    ...
    public Object eval(Object[] args, EvaluationContext ec) {
        ...
        if(imageName.length() > 0) {
            ...
            if (data == null) {
                ...
                app.startRemoteCall();
                //SmapRemoteWebServicePostTask task = new SmapRemoteWebServicePostTask();   XXXX
                //task.setSmapRemoteListener(app.getFormEntryActivity());    XXXX
                //task.execute(url, imageName, timeoutValue);    XXXX
                return "";
            } else {
                //return ExternalDataUtil.nullSafe(data);   XXXX
                return "";  // XXXX
            }
        } else {
            // No data to lookup
